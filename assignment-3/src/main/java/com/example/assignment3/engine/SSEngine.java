...
public class SSEngine {
    public final static String[] columns = {"A","B","C","D"};
    public final static int NROWS = 4;

    // association id->com.example.assignment3.engine.Cell for of all cells in the spreadsheet
