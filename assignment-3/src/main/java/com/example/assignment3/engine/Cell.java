package com.example.assignment3.engine;

import com.example.assignment3.util.Exclude;
...
public class Cell {
    ...
    private static void createAndAddCell(String id, String formula){
        ...
        if (isOK) {
            System.out.println("com.example.assignment3.engine.Cell "+c.id+" has no circular references");
            ssEngine.addCell(c);
        } else {
            System.out.println("com.example.assignment3.engine.Cell "+c.id+" has circular references - not added");
        }
        System.out.println("====================================");
    }
